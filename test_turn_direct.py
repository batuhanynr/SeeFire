#!/usr/bin/env python3
"""
SeeFire - Direct Wheel Turn Test (Isolated from SSH Keyboard Latency)
Rotates the robot right in place (Left wheels forward, Right wheels backward) 
at 50% speed for 3 seconds, then stops.
"""
import sys
import os
import time
...
def main():
    if MOCK_MODE:
        print("[MOCK] Motors starting to rotate right in place...")
        time.sleep(3)
    ...
    print("SUCCESS: Motors rotating right in place at 50% PWM!")
